...
class ExtendedCupertinoNavigationBar extends StatefulWidget
  ...
  @override
  State<ExtendedCupertinoNavigationBar> createState() =>
      _ExtendedCupertinoNavigationBarState();
}
...
class _ExtendedCupertinoNavigationBarState
    extends State<ExtendedCupertinoNavigationBar> {
...
class ExtendedCupertinoSliverNavigationBar extends StatefulWidget {
  ...
  @override
  State<ExtendedCupertinoSliverNavigationBar> createState() =>
      _ExtendedCupertinoSliverNavigationBarState();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _ExtendedCupertinoSliverNavigationBarState
    extends State<ExtendedCupertinoSliverNavigationBar> {
  late _NavigationBarStaticComponentsKeys keys;
...
class _LargeTitle extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
      BuildContext context, _RenderLargeTitle renderObject) {
